...
public class GreetingClientService {
	...
	private static final String GREETING_SERVICE_UID = "greeting-service-user";
	private static final String GREETING_SERVICE_PWD = "password";
	...
	public GreetingClientService(WebClient.Builder webClientBuilder, GreetingClientConfigs greetingConfigs ) {
		super();
		webClientBuilder.filter(basicAuthentication(GREETING_SERVICE_UID, GREETING_SERVICE_PWD));
