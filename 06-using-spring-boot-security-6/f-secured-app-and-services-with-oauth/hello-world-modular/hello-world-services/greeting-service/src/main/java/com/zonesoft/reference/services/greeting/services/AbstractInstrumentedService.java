...
public abstract class AbstractInstrumentedService {
	...
	public AbstractInstrumentedService(WebClient.Builder webClientBuilder, IClientConfigs configs, String uid, String pwd) {
		super();
		webClientBuilder.filter(basicAuthentication(uid, pwd));
