...
//		String info = "This is some info";
		StringBuilder htmlResponse = new StringBuilder();			
			...
			htmlResponse.append("<a href=\"/ui/show-greeting\">Invoke Greeting Service</a><br/><br/><br/>");
			htmlResponse.append("<div style=\"width:1200px; overflow:auto\">");
				htmlResponse.append("<pre style=\"white-space: pre-wrap\">");
					...
					htmlResponse.append("UI via Gateway                   https://localhost:8410/hello-world/ui/\n");
					htmlResponse.append("Greeting API via Gateway         https://localhost:8410/hello-world/api/greeting/get-greeting\n");
					htmlResponse.append("Clock API via Gateway            https://localhost:8410/hello-world/api/clock/get-time\n");
					htmlResponse.append("Calendar API via Gateway         https://localhost:8410/hello-world/api/calendar/get-date\n\n");
	
					htmlResponse.append("UI no Gateway                    https://localhost:8411/hello-world/ui/\n");
					htmlResponse.append("Greeting API no Gateway          https://localhost:8412/hello-world/api/greeting/get-greeting\n");
					htmlResponse.append("Clock API no Gateway             https://localhost:8413/hello-world/api/clock/get-time\n");
					htmlResponse.append("Calendar API no Gateway          https://localhost:8414/hello-world/api/calendar/get-date\n");
				htmlResponse.append("</pre>");
			htmlResponse.append("<div/>");
